...
import { getShifts, getShiftsWeb, getShiftsWeek, getUsers, getUsersWeb } from "../util/dbHandler";
import { RefreshControl, View, FlatList, Platform, Button } from "react-native";
      ...
      <FlatList
        ...
        renderItem={day => {
          return <DayCard
            ...
            showCreateShift={onShowCreateShift}
            editing={editing}
            date={day}
          />
        }}
